---
name: travel-city-walk-by-1uczxsi
description: "Apply an evidence-derived Cinematic travel montage workflow observed across published GoodCase examples by CaliraVal. Use when planning, storyboarding, or refining an AI video prompt in this motion pattern, including requests for 视频提示词, 分镜, 动作复刻, reference images, source video, or special generation steps. This is an unofficial synthesis and must preserve source attribution."
---

# CaliraVal · Cinematic travel montage
