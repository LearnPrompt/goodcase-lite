---
name: travel-city-walk
description: "Apply the Cinematic travel montage workflow derived from multiple published GoodCase examples. Use when planning, storyboarding, or refining an AI video prompt in this motion pattern, including requests for 视频提示词, 分镜, 动作复刻, reference images, source video, or special generation steps. Read the bundled Case evidence before producing an artifact."
---
