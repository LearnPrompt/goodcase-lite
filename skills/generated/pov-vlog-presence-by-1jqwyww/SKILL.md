---
name: pov-vlog-presence-by-1jqwyww
description: "Apply an evidence-derived POV and vlog presence workflow observed across published GoodCase examples by doctorwasif. Use when planning, storyboarding, or refining an AI video prompt in this motion pattern, including requests for 视频提示词, 分镜, 动作复刻, reference images, source video, or special generation steps. This is an unofficial synthesis and must preserve source attribution."
---

# doctorwasif · Phone Snapshot Gym Comedy
