...
- Summary: 一份为高端椰子水广告准备的详细多画面项目提示词。它概述了八个电影级场景，重点展示了冷凝水珠、液体旋涡和水花飞溅等产品细节，以高端广告代理商的风格呈现。
- Prompt excerpt:
...
- Summary: 一份全面的多场景项目提示词，专为展示正宗意大利面质感与电影级灯光效果的高端食品广告而设计。
- Prompt excerpt:
...
- Summary: 一个高能量的美食广告项目提示词，专注于方便面的微距摄影和动态灯光效果。
- Prompt excerpt:
