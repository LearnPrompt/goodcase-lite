---
name: pets-and-animals-lead
description: "Apply the Pets and animals as the lead workflow derived from multiple published GoodCase examples. Use when planning, storyboarding, or refining an AI video prompt in this motion pattern, including requests for 视频提示词, 分镜, 动作复刻, reference images, source video, or special generation steps. Read the bundled Case evidence before producing an artifact."
---
...
5. Hard-code exactly one animal with physical continuity and give it its own behaviour rules.
6. Buy realism with a camera-flaw list; forbid cinematic moves and grading.
7. Escalate beat by beat until it reaches the lens; location sound only.
