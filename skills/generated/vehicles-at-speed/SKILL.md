---
name: vehicles-at-speed
description: "Apply the Cars and vehicles at speed workflow derived from multiple published GoodCase examples. Use when planning, storyboarding, or refining an AI video prompt in this motion pattern, including requests for 视频提示词, 分镜, 动作复刻, reference images, source video, or special generation steps. Read the bundled Case evidence before producing an artifact."
---
...
5. Declare the total cut count and the share of pure kinetic shots.
6. Lock the vehicle by part: suspension, wheel spin, chain, exhaust.
7. One numbered cut per second, speed written into camera position and what whips past; end with a negative list of how the vehicle breaks.
